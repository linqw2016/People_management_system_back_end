...
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employees2Excel(List<Employee> list) {
        HSSFWorkbook workbook = new HSSFWorkbook();
        workbook.createInformationProperties();
        DocumentSummaryInformation docInfo = workbook.getDocumentSummaryInformation();
        docInfo.setCategory("员工信息");
        docInfo.setManager("linqw");
        docInfo.setCompany("www.linqw.org");
        SummaryInformation summInfo = workbook.getSummaryInformation();
        summInfo.setTitle("员工信息表");
        summInfo.setAuthor("linqw");
        summInfo.setComments("本文档由linqw提供");
        ...
        dateCellStyle.setDataFormat(HSSFDataFormat.getBuiltinFormat("m/d/yyyy"));
        //设置列的宽度；
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 8:
                                        ...
                                        break;
                                    case 9:
                                        int politicstatusIndex = allPoliticStatus.indexOf(new Politicsstatus(cellValue));
                                        employee.setPoliticId(allPoliticStatus.get(politicstatusIndex).getId());
                                        break;
                                    case 10:
